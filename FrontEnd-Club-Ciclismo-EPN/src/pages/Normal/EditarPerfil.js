...
const EditarPerfil = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      setFormData(prev => ({...prev, profile_picture: updatedData.profile_picture}));
  ...
  return (
    <div className="editar-perfil-container">
          ...
          <img
            src={
                ...
                ? (formData.profile_picture.startsWith("data:") 
                    ? formData.profile_picture 
                    : `${getEditImageUrl(formData.profile_picture)}?t=${imageTimestamp}`)
                : defaultProfile
            }
            alt="Foto de perfil"
      ...
      <div className="form-grid">
         ...
         <div>
           ...
           <select name="blood_type" value={formData.blood_type} onChange={handleChange}>
             ...
             <option value="A+">A+</option><option value="O+">O+</option><option value="AB+">AB+</option><option value="B+">B+</option>
           </select>
         </div>
         <div>
           <label>Nivel:</label>
      ...
      <div className="form-buttons-inline">
        ...
        <button className="btn-cancel" onClick={() => navigate("/user")}>Cancelar</button>
      </div>
    </div>
  );
};
